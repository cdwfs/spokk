...
typedef enum ImageFileDataFormat
{
    ...
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8_UNORM  = 60,
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8_SRGB   = 61,
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A1_UNORM = 62,
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A1_SRGB  = 63,
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A8_UNORM = 64,
    IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A8_SRGB  = 65,
    IMAGE_FILE_DATA_FORMAT_EAC_R11_UNORM      = 66,
    IMAGE_FILE_DATA_FORMAT_EAC_R11_SNORM      = 67,

...
struct Image {
  ...
  int CreateFromFile(const DeviceContext& device_context, const DeviceQueue *queue,
  ...
  int LoadSubresourceFromMemory(const DeviceContext& device_context, const DeviceQueue *queue,

...
public:
  ...
  int LoadFromFile(VkImage *out_image, VkImageCreateInfo *out_image_ci,
  ...
  int GenerateMipmaps(VkImage image, const VkImageCreateInfo &image_ci,
...
private:
  int RecordMipmapGeneration(VkCommandBuffer cb, VkImage image, const VkImageCreateInfo &image_ci,
...
struct Image {
  ...
  VkResult CreateAndLoad(const DeviceContext& device_context, const ImageLoader& loader,

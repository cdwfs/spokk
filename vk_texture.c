...
static VkFormat ImageFormatToVkFormat(ImageFileDataFormat format)
{
    ...
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8_UNORM:  return VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8_SRGB:   return VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A1_UNORM:return VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A1_SRGB: return VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A8_UNORM:return VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_ETC2_R8G8B8A8_SRGB: return VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_EAC_R11_UNORM:      return VK_FORMAT_EAC_R11_UNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_EAC_R11_SNORM:      return VK_FORMAT_EAC_R11_SNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_EAC_R11G11_UNORM:   return VK_FORMAT_EAC_R11G11_UNORM_BLOCK;
    case IMAGE_FILE_DATA_FORMAT_EAC_R11G11_SNORM:   return VK_FORMAT_EAC_R11G11_SNORM_BLOCK;

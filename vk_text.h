...
public:
  ...
  int RenderStringToBitmap(const StringRenderInfo& info, uint32_t bitmap_w, uint32_t bitmap_h, uint8_t *bitmap_pixels) const;
...
private:
  ...
  void ComputeGlyphInfoAndBitmapDimensions(const StringRenderInfo& info,

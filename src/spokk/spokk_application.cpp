...
static VkBool32 MyDebugUtilsCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
  ...
  if (messageSeverity & VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT) {
    ...
    uint32_t messageId = static_cast<uint32_t>(pCallbackData->messageIdNumber);
    if (0
        // clang-format off
      ...
      || messageId == 0xb3d4346b // UNASSIGNED-BestPractices-vkBindMemory-small-dedicated-allocation
                                ...
                                // of direct vkAllocateMemory(), to service multiple VRAM allocations
                                // from the same device allocation.
      || messageId == 0x2dc65ef4 // UNASSIGNED-BestPractices-vkCreateInstance-specialuse-extension
                                // This warning just means "using VK_EXT_validation_features is for debugging
                                // only, don't ship with it".
      || strcmp(pCallbackData->pMessageIdName, "UNASSIGNED-CoreValidation-DrawState-InvalidImageLayout") == 0
                                // UNASSIGNED-CoreValidation-DrawState-InvalidImageLayout
                                // This warning is generated by VulkanMemoryAllocator. See note in vk_mem_alloc.h:
